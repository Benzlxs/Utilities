...
root_dir = '/home/li325/dataset/dynamic_scene/data/NeRF-DS/cup_novel_view'
root_dir = Path(root_dir)

ratio = "1x"

image_dir = root_dir.joinpath("rgb/" + ratio)
mask_dir = root_dir.joinpath("mask/1x")
output_dir = root_dir.joinpath("rgb_static/" + ratio)
...
for one_img_dir in all_dir_list:
    ...
    mask_path = str(mask_dir.joinpath(image_name + ".png"))
